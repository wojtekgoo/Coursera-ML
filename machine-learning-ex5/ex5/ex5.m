...
close all;
fprintf("\n3.4 Optional (ungraded) exercise: Computing test set error\n");
fprintf("To train optimal weights we use lambda = 3 as it has lowest error on cross validation set\n")

lambda = 3;

fprintf("Optimal weights: ");
[optimal_theta] = trainLinearReg(X_poly, y, lambda)

fprintf( "\nJ_test = %f\n", linearRegCostFunction(X_poly_test, ytest, optimal_theta, 0) )